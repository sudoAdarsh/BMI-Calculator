...
class App(ctk.CTk):
    ...
    def input_section(self):
        ...
        weight_label.grid(row=0, column=0, padx=5, pady=5, sticky="ew")
        ...
        self.weight_unit = ctk.CTkOptionMenu(input_frame, values=["kg", "lbs"], font=("Arial", 16))
        ...
        height_label.grid(row=1, column=0, padx=5, pady=5, sticky="ew")
        ...
        # Input options
        self.height_unit = ctk.CTkOptionMenu(input_frame, font=("Arial", 16), values=["cm", "inches"])
        ...
        calc_button.grid(row=2, column=0 , columnspan=2, pady=10, padx=10)

        # Result Label
        self.result_label = ctk.CTkLabel(input_frame, text="", font=("Arial", 18))
    ...
    def calc_bmi(self):
        try:
            ...
            self.result_label.configure(text=f"BMI: {bmi} ({category})")
